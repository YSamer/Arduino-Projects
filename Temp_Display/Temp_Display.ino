...
//  EEPROMFloatWrite(14,5.0);
  ...
  difUH = EEPROMFloatRead(3);
  difDH = EEPROMFloatRead(10);
...
void loop() {
  ...
  {    
    ...
    if(getTemp()>=(getOTemp()+hAlT)){
      ...
      onAlert();
    }else if(hum>=(oHum+hAlH)){
      onAlert();
    }else if(hum<=(oHum-lAlH)){
      onAlert();
    }else offAlert();
    ...
    }
    {
      ...
      if(state3==12){
        ...
        switch(checkButton()){
          ...
          case 3: state3 = 1; break;
          case 4: state3 = 121; break;
        }
      }

      {
        if(state3==121){//dif Hum up
          setY(0,X[19],X[23]);
          Display();
          switch(checkButton()){
            case 1: state3 = 122; break;
            case 2: state3 = 122; break;
            case 3: state3 = 12; break;
            case 4: state3 = 1211; break;
          }
        }
        if(state3==1211){
          setYf(difUH);
          Display();
          switch(checkButton()){
            case 1: if(difUH>0&&difUH<=5.1){difUH-=0.1;} break;
            case 2: if(difUH>=-1&&difUH<5.0){difUH+=0.1;} break;
            case 3: state3 = 121; EEPROMFloatWrite(3,difUH); break;
            case 4: state3 = 121; EEPROMFloatWrite(3,difUH); break;
          }
        }
        if(state3==122){//dif Hum down
          setY(0,X[20],X[13]);
          Display();
          switch(checkButton()){
            case 1: state3 = 121; break;
            case 2: state3 = 121; break;
            case 3: state3 = 12; break;
            case 4: state3 = 1221; break;
          }
        }
        if(state3==1221){
          setYf(difDH);
          Display();
          switch(checkButton()){
            case 1: if(difDH>0&&difDH<=5.1){difDH-=0.1;} break;
            case 2: if(difDH>=-1&&difDH<5.0){difDH+=0.1;} break;
            case 3: state3 = 122; EEPROMFloatWrite(10,difDH); break;
            case 4: state3 = 122; EEPROMFloatWrite(10,difDH); break;
          }
        }
      }
...
int checkButton(){
  ...
  if((analogRead(BT)>150&&analogRead(BT)<200)&&(millis()-lBTime>100)){
