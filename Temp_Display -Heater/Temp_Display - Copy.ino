...
if(layer == 0){
 {
    ...
    if (isnan(hum) || isnan(temp) || isnan(tempF)) {
      ...
      switch(checkButton()){
        ...
        case 2: break;
        case 3: break;
        case 4: layer = 1; state1 = 0; goto layer1; break;
      }
      //Set Configration
      lBTime = millis();
    ...
    if(getTemp()<=(getOTemp()-difDT)&&Try<=3){
      ...
      if(millis()-lHTime<3000){
        digitalWrite(R1,LOW);
        digitalWrite(R2,LOW);
        digitalWrite(R3,HIGH);
      }else if((millis()-lHTime>=3000)&&(millis()-lHTime<6000)){
...
//          digitalWrite(R2,LOW);
//          digitalWrite(R3,HIGH);
//        }else if((millis()-lHTime>=3000)&&(millis()-lHTime<5000)){
//          digitalWrite(R1,HIGH);
//          digitalWrite(R2,LOW);
//          digitalWrite(R3,HIGH);
//        }else if((millis()-lHTime>=5000)&&(analogRead(cell)<600)){
//          digitalWrite(R1,HIGH);
//          digitalWrite(R2,LOW);
//          digitalWrite(R3,LOW);
//        }else if((millis()-lHTime>=5000)&&(analogRead(cell)>=600)){
...
//          
//        }
//      }else if((ptTRead()>offf)&&(ptTRead()<=onf)){
//        if(millis()-lHTime<3000){
//          digitalWrite(R1,LOW);
//          digitalWrite(R3,HIGH);
//        }else if((millis()-lHTime>=3000)&&(millis()-lHTime<5000)){
...
//          Try++;
//        }
//      }else if((ptTRead()>onf)&&(ptTRead()<=offp)){
//        digitalWrite(R2,HIGH);
//      }else if(ptTRead()>offp){
//        digitalWrite(R1,LOW);
//        digitalWrite(R3,LOW);
//        digitalWrite(R2,HIGH);
//      }
